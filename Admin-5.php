...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `overtimes` SET `status` = 'accepted', `approved_at` = CURRENT_TIMESTAMP, `approved_by` = '$realName', `approver_signature` = '$realSignature' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "Overtime Form has been Approved!";
...
if (isset($_POST['reject'])) 
{
    ...
    if($rejectQuery){
      $_SESSION['status'] = "Overtime Form has been Rejected!";
      $_SESSION['status_code'] = "success";
      header('Location: Admin-5.php');
      exit(0);
...
<?php $conn = new PDO("mysql:host=$host;dbname=$database", $user, $password);
              ...
              ?>
<a class="collapse-item active" href="Admin-5.php"><i class="fas fa-fw fa-user-clock"></i>  Overtime <?php echo $value4; ?></a>
<?php } ?>
<!-- ======================================================================================================================================-->
<!-- ======================================================================================================================================-->
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `overtimes` WHERE `status` = 'recommended';";
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="Admin-5.php" method="post">
        <div class="container-fluid">
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
      
          <h6>Are you sure you want to approve this Overtime request?</h6>
            </div>
        </div>
