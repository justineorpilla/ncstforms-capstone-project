...
<html lang="en">
	<head>
		...
		<title>NCST</title>
		<!-- Favicon -->
		<link rel="icon" type="image/png" sizes="56x56" href="images/NCST.png">
		<!-- Main style sheet -->
		...
		<div class="main-page-wrapper">
						...
						<div class="row">
							<!-- <div class="col-md-6 col-sm-8 col-12">
								<ul class="left-widget">
									<li>We are the leading industry-based educational institution!</li>
									<li>
							...
							<!-- <div class="col-md-6 col-sm-4 col-12">
								...
								https://www.facebook.com/NCST.OfficialPage/
								    https://twitter.com/NCST_dasma
									https://plus.google.com/103432465123825425091
				...
				<div class="theme-menu-wrapper">
					<div class="container">
						<div class="bg-wrapper clearfix">
							<div class="logo float-left"><a href="index.php"><img src="images/logo/n7b.png" alt=""></a></div>
							<!-- ============== Menu Warpper ================ -->
					   		<div class="menu-wrapper float-left">
								   ...
								   <ul class="clearfix">
									    ...
									    <li><a href="#">Forms</a>
									    	<ul class="dropdown">
									        	<li><a href="project.html">Forms</a></li>
									        	<li><a href="project-details.html">Form details</a></li>
									       </ul>
									    </li>
									    <!-- <li><a href="#">Blog</a>
									    	<ul class="dropdown">
					   		...
					   		<div class="right-widget float-right">
					   			<ul>
					   				<li>  <button onclick="window.location.href='sblogin.php'"> Login <span class="fa fa-user-circle">  </span> </button></li>
									   <!-- <a href="sblogin.php" class="">Login</a> -->
					   			</ul>
					   		</div> <!-- /.right-widget -->
						</div> <!-- /.bg-wrapper -->
					</div> <!-- /.container -->
			...
			<div id="theme-main-banner" class="banner-one">
				<div data-src="images/b1.jpg">
					<div class="camera_caption">
						<div class="container">
							<p class="wow fadeInUp animated">National College of Science and Technology</p>
							<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">WELCOME TO EMPLOYEE PERSONAL <br> FORMS APPLICATION</h1>
							<a href="https://drive.google.com/file/d/1IoXXvCs2NKGGSFIvlsFtPES1RBcV379Z/view" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">DOWNLOAD APP</a>
						</div> <!-- /.container -->
					</div> <!-- /.camera_caption -->
				</div>
				<div data-src="images/nc7.jpg">
					<div class="camera_caption">
						<div class="container">
							<p class="wow fadeInUp animated">National College of Science and Technology</p>
							<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">ONLINE EMPLOYEE PERSONAL <br> FORMS</h1>
							<a href="https://drive.google.com/file/d/1IoXXvCs2NKGGSFIvlsFtPES1RBcV379Z/view" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">DOWNLOAD APP</a>
						</div> <!-- /.container -->
					</div> <!-- /.camera_caption -->
				</div>
				<div data-src="images/nc6.jpg">
					<div class="camera_caption">
						<div class="container">
							<p class="wow fadeInUp animated">National College of Science and Technology</p>
							<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">ONLINE EMPLOYEE PERSONAL <br> FORMS</h1>
			...
			<div class="callout-banner section-spacing">
				<div class="container clearfix">
					<h3 class="title">Convenient way to apply a form!</h3>
					...
					<a href="sblogin.php" class="theme-button-one">APPLY NOW!</a>
				</div>
			</div> <!-- /.callout-banner -->
			...
			<div class="our-case section-spacing">
				<div class="container">
					<div class="theme-title-one">
						<h2>Our FORMS</h2>
						<p>Take a look of our available form for you to apply</p>
					</div> <!-- /.theme-title-one -->
					<div class="wrapper">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Cash Advance</a></h5>
												<p>NCST Form Application</p>
											</div>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Leave</a></h5>
												<p>NCST Form Application</p>
											</div>
											<a href="project-details.html" class="details float-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
										</div> <!-- /.text -->
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Official Business</a></h5>
												<p>NCST Form Application</p>
											</div>
											<a href="project-details.html" class="details float-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
										</div> <!-- /.text -->
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Overtime</a></h5>
												<p>NCST Form Application</p>
											</div>
											<a href="project-details.html" class="details float-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
										</div> <!-- /.text -->
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Undertime</a></h5>
												<p>NCST Form Application</p>
											</div>
											<a href="project-details.html" class="details float-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
										</div> <!-- /.text -->
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									...
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Substitution</a></h5>
												<p>NCST Form Application</p>
											</div>
											<a href="project-details.html" class="details float-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
										</div> <!-- /.text -->
			...
			<footer class="theme-footer-two">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12 logo-widget">
								<div class="logo"><a href="index.html"><img src="images/logo/n7w.png" alt=""></a></div>
								<p>CAPSTONE PROJECT: THE DEVELOPMENT OF FACULTY AND EMPLOYEE PROFILING AND ADMINISTRATIVE RELATED FORMS APPLICATION AND APPROVAL SYSTEM.</p>
								<ul class="social-icon">
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
							...
							<div class="col-lg-3 col-sm-6 col-12 footer-gallery">
								...
								<div class="wrapper">
									<div class="row">
										<div class="col-4">
											<a href="images/PT1.png" data-fancybox="gallery" data-caption="PUM Netherlands Senior Experts" class="fancybox"><img src="images/PT1.png" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/pt2.png" data-fancybox="gallery" data-caption="Singapore Polytechnic" class="fancybox"><img src="images/pt2.png" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/pt3w.png" data-fancybox="gallery" data-caption="Philippine Red Cross" class="fancybox"><img src="images/pt3w.png" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/pt4.png" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="images/pt4.png" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/pt5.png" data-fancybox="gallery" data-caption="Analog Devices" class="fancybox"><img src="images/pt5.png" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/pt6.png" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="images/pt6.png" alt=""></a>
										</div>
									</div>
								</div>
							</div> <!-- /.footer-gallery -->
							...
							<div class="col-lg-3 col-sm-6 col-12 contact-widget">
								...
								<ul>
									...
									<li>
										...
										<a href="#">info@ncst.edu.ph</a>
									</li>
									<li>
										<i class="fa fa-phone" aria-hidden="true"></i>
										<a href="#">(046) 416-6278</a>
									</li>
									<li>
										<i class="fa fa-mobile" aria-hidden="true"></i>
										<a href="#">0918-888-6278</a>
									</li>
								</ul>
							</div> <!-- /.contact-widget -->
						</div> <!-- /.row -->
				...
				<div class="bottom-footer">
					<div class="container">
						<p>&copy; Copyrights 2021. National College of Science & Technology.</p>
					</div>
				</div> <!-- /.bottom-footer -->
