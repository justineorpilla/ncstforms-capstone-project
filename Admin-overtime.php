...
<div class="container">
    <?php 
        ...
        $query = "SELECT * FROM `overtimes` WHERE `status` = 'pending';";
        ...
        <p class="lead text-muted">
            <?php echo $row['requested_by']." would like to request for an Overtime on ".$row['date'].". <br> Hours: ".$row['hours']." <br> Work to Accomplish: ".$row['reason'] ?></p>
        <p>
                <a href="accept.php?id=<?php echo $row['id']?>&type=overtime" class="btn btn-primary my-2">Accept</a>
                <a href="reject.php?id=<?php echo $row['id']?>&type=overtime" class="btn btn-secondary my-2">Reject</a>
        </p>
