...
<nav class="navbar navbar-light" style="background-color: #0d47a1; ">
  ...
  <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img src="images/NCST.png" width="43" height="40" class="d-inline-block align-top" alt=""></a>
    </div>
...
<div class="row">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="images/nc2.jpg" alt="Image">
          <div class="carousel-caption">
            <h3>Enroll Now</h3>
            <p>For incoming College, Senior High School and Transferees</p>
          </div>      
        </div>

        <div class="item">
          <img src="images/nc4.jpg" alt="Image">
          <div class="carousel-caption">
            <h3>National College of Science and Technology</h3>
  ...
  <div class="col-sm-4">
    ...
    <div class="well">
       <p><span class="glyphicon glyphicon-bookmark"></span> Last day of Enrollment</p>
       <p><span class="glyphicon glyphicon-bookmark"></span> Last day of Payment for Unpaid Students</p>
       <p><span class="glyphicon glyphicon-bookmark"></span> All Saint's Day</p>
       <p><span class="glyphicon glyphicon-bookmark"></span> All Soul's Day</p>
    </div>
    ...
    <div class="card">
                ...
                <div class="fb-page fb_iframe_widget" data-href="https://www.facebook.com/NCST.OfficialPage" data-tabs="timeline" data-width="300" data-height="70" data-small-header="true" data-adapt-container-width="true" data-hide-cover="true" data-show-facepile="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=true&amp;app_id=&amp;container_width=533&amp;height=70&amp;hide_cover=true&amp;href=https%3A%2F%2Fwww.facebook.com%2FNCST.OfficialPage&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=true&amp;tabs=timeline&amp;width=300"><span style="vertical-align: bottom; width: 300px; height: 70px;"><iframe name="f383ec8d56cbb2" width="300px" height="70px" data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v8.0/plugins/page.php?adapt_container_width=true&amp;app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df215d533ff2be9%26domain%3Dchukulitayskrim.000webhostapp.com%26origin%3Dhttp%253A%252F%252Fchukulitayskrim.000webhostapp.com%252Ffd71dc1e35a5b4%26relation%3Dparent.parent&amp;container_width=533&amp;height=70&amp;hide_cover=true&amp;href=https%3A%2F%2Fwww.facebook.com%2FNCST.OfficialPage&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=true&amp;tabs=timeline&amp;width=300" style="border: none; visibility: visible; width: 300px; height: 70px;" class=""></iframe></span></div>
              </div><!-- /.card -->
            </div><!-- /.col -->
    </div>
  </div>
...
<div class="container text-center">    
  ...
  <div class="row">
    <div class="col-sm-2">
      <img src="images/PT1.png" class="img-responsive" style="width:100%" alt="Image">
     
    </div>
    <div class="col-sm-2"> 
      <img src="images/pt2.png" class="img-responsive" style="width:100%" alt="Image">
       
    </div>
    <div class="col-sm-2"> 
      <img src="images/pt3.png" class="img-responsive" style="width:100%" alt="Image">
     
    </div>
    <div class="col-sm-2"> 
      <img src="images/pt4.png" class="img-responsive" style="width:100%" alt="Image">
     
    </div> 
    <div class="col-sm-2"> 
      <img src="images/pt5.png" class="img-responsive" style="width:100%" alt="Image">
      
    </div>     
    <div class="col-sm-2"> 
      <img src="images/pt6.png" class="img-responsive" style="width:100%" alt="Image">
...
<footer class="page-footer font-small blue pt-4">
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <!-- Content -->
        <h5 class="text-uppercase" style="color: yellow;">Capstone Project</h5>
        <p style="color: yellow;">THE DEVELOPMENT OF FACULTY AND EMPLOYEE PROFILING AND ADMINISTRATIVE RELATED FORMS APPLICATION AND APPROVAL SYSTEM.</p>
      ...
      <div class="col-md-3 mb-md-0 mb-3">
        ...
        <!-- Links -->
        <h5 class="text-uppercase" style="color: yellow;">National College of Science and Technology</h5>
        ...
        <ul class="list-unstyled">
          ...
          <li>
            <a href="#!" style="color: white;">Mision and Vision</a>
          </li>
          <li>
            <a href="#!" style="color: white;">Location</a>
          </li>
          <li>
            <a href="#!" style="color: white;">Partners</a>
          </li>
        </ul>
      ...
      <div class="col-md-3 mb-md-0 mb-3">
        ...
        <!-- Links -->
        <h5 class="text-uppercase" style="color: yellow;">Contacts</h5>

        <ul class="list-unstyled" >
          <li>
            <a href="#!" style="color: white;">Amafel Building Aguinaldo Highway, Dasmariñas City, Cavite</a>
          </li>
          <li>
            <a href="#!" style="color: white;"><span class="glyphicon glyphicon-earphone"></span> (046) 416-6278</a>
          </li>
          <li>
            <a href="#!" style="color: white;"><span class="glyphicon glyphicon-phone"> 0918-888-6278</a>
          </li>
          <li>
            <a href="#!" style="color: white;"><span class="glyphicon glyphicon-envelope"> info@ncst.edu.ph</a>
          </li>
        </ul>
  ...
  <div class="footer-copyright text-center py-3">© 2020 Copyright:
    <a href="https://ncst.edu.ph/"> National College of Science and Technology - THESIS B</a>
  </div>
  <!-- Copyright -->
