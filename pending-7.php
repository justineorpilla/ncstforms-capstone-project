<?php // PENDING-7.PHP FOR PENDING OVERTIME TO RECOMMEND (USER: SUPERVISOR)
...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `overtimes` SET `status` = 'recommended', `recommended_at` = CURRENT_TIMESTAMP, `recommended_by` = '$realName', `recommendor_position` = '$realPosition', `recommendor_signature` = '$realSignature' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "Overtime has been Recommended!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-7.php');
      exit(0);
...
if (isset($_POST['reject'])) 
{
    ...
    $reject="UPDATE `overtimes` SET `status` = 'rejected', `approved_at` = CURRENT_TIMESTAMP, `approved_by` = '$realName', `reject_signature` = '$realSignature', `remarks` = '$remarks' WHERE `id` = '$delete_id';";
    $rejectQuery=mysqli_query($connection,$reject);
       
    if($rejectQuery){
      $_SESSION['status'] = "Overtime has been Rejected!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-7.php');
      exit(0);
...
<!--=====================================================================================================================-->         
        ...
        <div class="card-body">
          ...
          Process: Recommend: Supervisor | Final Approved: Administrator</h6>
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `overtimes` WHERE `status` = 'pending' AND `department` = '$realDepartment';";
  ...
  ?>
    ...
    <tr>
      ...
      <td>
          ...
          <p class="">Overtime Date: <b><?php echo date("M d, Y",strtotime($row['date'])); ?></b></p>
          <p class="ex1">OT Hours Requested: <b><?php echo $row['hours']; ?></b></p>
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="pending-7.php" method="post">
        <div class="container-fluid">
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
          <h5>Are you sure you want to recommend this Overtime Request?</h5>
