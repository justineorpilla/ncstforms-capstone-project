<?php // PENDING-7.PHP FOR PENDING IOM TO RECOMMEND (USER: SUPERVISOR)
...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `ioms` SET `status` = 'noted', `noted_at` = CURRENT_TIMESTAMP, `noted_by` = '$realName', `noter_signature` = '$realSignature' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "IOM has been Noted!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-11.php');
      exit(0);
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `ioms` WHERE `status` = 'pending' AND `department` = '$realDepartment';";
...
p.ex1 { margin-top: -20px;}
  ...
  ?>
    ...
    <tr>
      ...
      <td><center>
          <button type="button" class="btn btn-success btn-sm mb-2" data-toggle="modal" data-target="#approve<?php echo $row['id']; ?>">
          Recommend</button>
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="pending-11.php" method="post">
        <div class="container-fluid">
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
          <h5>Are you sure you want to recommend this IOM Request?</h5>
          <small><p style="color:green;">(This form will be sent to the Recipient Department Head for final approval)</p></small>
            </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <form action="pending-11.php" method="post">
        ...
        <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
            <h6 style="float: left;">Are you sure you want to reject this IOM request?</h6>
