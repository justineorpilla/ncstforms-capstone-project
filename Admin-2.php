...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `leaves` SET `status` = 'accepted', `approved_at` = CURRENT_TIMESTAMP, `approved_by` = '$realName', `final_signature`='$realSignature' WHERE `id` = '$approve_id';";
...
<?php $conn = new PDO("mysql:host=$host;dbname=$database", $user, $password);
              ...
              ?>
<a class="collapse-item active" href="Admin-2.php"><i class="fas fa-fw fa-file-alt"></i> Leave <?php echo $value2; ?></a>
<?php } ?>
<!-- ======================================================================================================================================-->
<!-- ======================================================================================================================================-->
...
<!--=====================================================================================================================-->         
        ...
        <div class="card-body">
          ...
          Form Process: 1. Pending | 2. Recommended by: Dept.Head | 3. Endorsed by: School Nurse (if SL) | 4. First Approval: Campus Manager | 5. Final Approval: Admin</h6>
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `leaves` WHERE `status` = 'campus';";
...
<td>
         ...
         Approved by:  <b><?php echo $row['approve_manager']; ?></b>, <small> Campus Manager</small> <br>
         Final Approval: <b>Pending</b>
</td>
<?php }else{ ?>
<td>
         Recommended by:  <b>Jose Manalo</b>, <small>Supervisor</small><br>
         Approved by:  <b>Jaz Dixon</b>, <small> Campus Manager</small> <br>
         Final Approval: <b>Pending</b>
</td>
<?php } ?>
      <td>
    ...
    <div class="modal-content">
      ...
      <form action="Admin-2.php" method="post">
        ...
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
          ...
          <h6>Are you sure you want to approve this Leave form?</h6>
            </div>
        </div>
