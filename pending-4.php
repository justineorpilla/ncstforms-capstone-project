<?php // PENDING-4.PHP FOR PENDING UNDERTIME TO ENDORSED (USER LEVEL: SUPERVISOR)
...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `undertimes` SET `status` = 'endorsed', `recommended_at` = CURRENT_TIMESTAMP, `recommended_by` = '$realName', `endorser_position` ='$realPosition', `reco_signature` = '$realSignature' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "Undertime has been Endorsed!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-4.php');
      exit(0);
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `undertimes` WHERE `status` = 'pending' AND `sick` = 'no' AND `department` = '$realDepartment';";
  ...
  ?>
    ...
    <tr>
      ...
      <td>
          ...
          <p class="ex1">Undertime Date: <?php echo empty(date($row['date'])) ? "N/A" : date("M d, Y",strtotime($row['requested_at'])); ?></p>
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="pending-4.php" method="post">
