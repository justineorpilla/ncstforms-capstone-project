<?php // PENDING-2.PHP FOR PENDING LEAVES TO ENDORSED (USER LEVEL: NURSE)
...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `leaves` SET `status` = 'endorsed', `endorsed_at` = CURRENT_TIMESTAMP, `endorsed_by` = '$realName', `endorser_signature` = '$realSignature', `endorser_position` = '$realPosition' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "Leave has been Endorsed!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-2.php');
      exit(0);
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `leaves` WHERE `status` = 'recommended' AND `type` = 'Sick Leave';";
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="pending-2.php" method="post">
        <div class="container-fluid">
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
          <h5>Are you sure want to endorsed this Leave?</h5>
          <small><p style="color:green;">(This Sick Leave (SL) will be sent to the
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-success" id="approve" name="approve" value="Endorsed">
        </form>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <form action="pending-2.php" method="post">
        ...
        <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
            <h6 style="float: left;">Are you sure you want to reject this Sick Leave?</h6>
