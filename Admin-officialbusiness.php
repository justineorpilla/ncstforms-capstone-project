...
<div class="container">
    <?php 
        ...
        <p class="lead text-muted">
            <?php echo $row['requested_by']." would like to request for a visit on ".$row['date'].". <br> Office To Visit: ".$row['office_to_visit']." <br> Person To Visit: ".$row['person_to_visit']." <br> Purpose of Visit: ".$row['purpose_of_visit']." <br> Mode of Transport: ".$row['mode_of_transport'] ?></p>
        <p>
                <a href="accept.php?id=<?php echo $row['id']?>&type=official_business" class="btn btn-primary my-2">Accept</a>
                <a href="reject.php?id=<?php echo $row['id']?>&type=official_business" class="btn btn-secondary my-2">Reject</a>
        </p>
