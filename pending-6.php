<?php // PENDING-6.PHP FOR PENDING OFFICIAL BUSINESS TO RECOMMEND (USER LEVEL: SUPERVISOR)
...
if (empty($_SESSION['id']) && empty($_SESSION['user_name'])) {
  ...
  $realSigature = $_SESSION['signature'];
}
...
if (isset($_POST['approve'])) 
{
    ...
    $approve="UPDATE `official_businesses` SET `status` = 'recommended', `approved_at` = CURRENT_TIMESTAMP, `recommended_by` = '$realName', `recommendor_signature` = '$realSigature', `recommendor_position` = '$realPosition' WHERE `id` = '$approve_id';";
    $approveQuery=mysqli_query($connection,$approve);
       
    if($approveQuery){
      $_SESSION['status'] = "Official Business has been Recommended!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-6.php');
      exit(0);
...
if (isset($_POST['reject'])) 
{
    ...
    $reject="UPDATE `official_businesses` SET `status` = 'rejected', `approved_at` = CURRENT_TIMESTAMP, `approved_by` = '$realName', `reject_signature` = '$realSigature', `remarks` = '$remarks' WHERE `id` = '$delete_id';";
    $rejectQuery=mysqli_query($connection,$reject);
       
    if($rejectQuery){
      $_SESSION['status'] = "Official Business has been Rejected!";
      $_SESSION['status_code'] = "success";
      header('Location: pending-6.php');
      exit(0);
...
<!--=====================================================================================================================-->         
        ...
        <div class="card-body">
          ...
          Process: Recommend | Final Approved: Administrator</h6>
...
<!--=====================================================================================================================-->
           ...
           <div class="tab-content mt-3">
            <div class="tab-pane active" id="leave" role="tabpanel">
              <!-- Start -->
<?php
$query = "SELECT * FROM `official_businesses` WHERE `status` = 'pending' AND `department` = '$realDepartment';";
...
<!-- =======================================================================================================================-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="pending-6.php" method="post">
        <div class="container-fluid">
        <input type="hidden" name="accept_id" value="<?php echo $row['id']; ?>">
            <div class="form-group">
          <h5>Are you sure you want to recommend this Official Business Request?</h5>
