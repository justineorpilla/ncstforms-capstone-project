...
<?php if($_SESSION['position']=='Department Head') { ?>
  <div class="container">
<h6 class="h5 mb-0 text-gray-800">Pending IOM Form Applications: </h6>
  <div class="row mt-2">
...
foreach($conn->query("SELECT COUNT(*) FROM `ioms` WHERE `status` = 'pending' AND `department` = '$realDepartment';") as $count2) { 
  $value2 = $count2['COUNT(*)'];
  if($value2>0){
  }else {
    $value2 = "No ";
...
?>
        <div class="col-md-3  col-sm-6 col-xs-6 mt-2">
            <div class="card card-inverse card-success text-center">
              <img class="card-img-top" src="img/7.jpg" alt="Leave" class="responsive">
              <div class="card-block">
                <h4 class="card-title mt-2">IOM Form <small>(To be Noted)</small></h4>
                <p class="card-text"><span class="badge badge-primary"><?php echo "<b>" . $value2 . "</b>"; ?> Pending Request</span></p>
                <div class="card-footer"><a href="pending-11.php"> View <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></div>
            </div>
            </div>
        </div>
<?php } ?>
...
<?php $conn = new PDO("mysql:host=$host;dbname=$database", $user, $password);
foreach($conn->query("SELECT COUNT(*) FROM `ioms` WHERE `status` = 'noted' AND `department` = '$realDepartment';") as $count3) { 
  $value3 = $count3['COUNT(*)'];
  if($value3>0){
  }else {
    $value3 = "No ";
...
?>
        <div class="col-md-3  col-sm-6 col-xs-6 mt-2">
            <div class="card card-inverse card-info text-center">
              <img class="card-img-top" src="img/8.jpg" alt="Official Business" class="responsive">
              <div class="card-block">
                <h4 class="card-title mt-2">IOM Form <small>(To Approve)</small></h4>
                <p class="card-text"><span class="badge badge-primary"><?php echo "<b>" . $value3 . "</b>"; ?> Pending Request</span></p>
                <div class="card-footer"><a href="pending-12.php"> View <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></div>
            </div>
            </div>
        </div>
<?php } ?>
