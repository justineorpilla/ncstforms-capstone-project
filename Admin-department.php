...
<?php 
$name = $_SESSION['name'];
$query = "SELECT * FROM `ncst-departments`;";
...
if (isset($_POST['add'])) 
{
    ...
    $add="INSERT INTO `ncst-departments`(`department`) VALUES ('$addDept')";
    $addQuery=mysqli_query($connection,$add);
       
    if($addQuery){
      $_SESSION['status'] = "Department Successfully Added!";
...
if (isset($_POST['update'])) 
{
    ...
    $update="UPDATE `ncst-departments` SET `department`='$deptName' where id=$newId;";
...
if (isset($_POST['delete'])) 
{
    ...
    $delete="DELETE FROM `ncst-departments` WHERE id=$deleteId;";
    $deleteQuery=mysqli_query($connection,$delete);
       
    if($deleteQuery){
      $_SESSION['status'] = "Department has been Deleted!";
      $_SESSION['status_code'] = "success";
      header('Location: Admin-department.php');
      exit(0);
  ...
  <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Manage:</h6>
        ...
        <a class="collapse-item active" href="Admin-department.php"><i class="fa fa-list"></i> Departments</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="h4 m-0 font-weight-bold text-primary">Department List
<!-- ADD Button trigger modal -->          
<span class="float:right"><button type="button" class="btn btn-primary mb-2 float-right" data-toggle="modal" data-target="#department">
<i class="fa fa-plus"></i> Add Department
</button></span>
<!-- ADD Modal BTN START =======================================================================================-->
<div class="modal" id="department" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="Admin-department.php" method="post">
        <div class="container-fluid">
            ...
            <h6 style="float: left;">Department Name</h6>
          <input class="form-control" type="text" name="addDept" value="" required/>
            </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" id="add" name="add" value="Add Department">
        </form>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <form action="Admin-department.php" method="post">
        ...
        <input type="hidden" name="newId" value="<?php echo $row['id']; ?>">
            <div class="form-group">
            <h6 style="float: left;">Department Name</h6>
          <input class="form-control" type="text" name="dname" value="<?php echo $row['department'];?>"/>
            </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <form action="Admin-department.php" method="post">
        ...
        <input type="hidden" name="deleteId" value="<?php echo $row['id']; ?>">
            <div class="form-group">
            <h6 style="float: left;">Are you sure you want to delete this Department?</h6>
            </div>
        </div>
        </div>
      <div class="modal-footer">
